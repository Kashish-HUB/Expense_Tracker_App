...
import com.example.expensetracker.BudgetManagement.Transaction
...
class BudgetTransactionAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TransactionViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.budget_item_transaction, parent, false)
